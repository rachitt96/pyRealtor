...
setup(
    ...
    package_data = {
        'pyRealtor': [
            ...
            'config/column_mapping_cfg_housing_com.json',
            'config/column_mapping_cfg_housing_com_rent.json',
            'config/column_mapping_cfg_realtor_ca_agri.json',
            'config/graphql_queries.yml',
            'config/graphql_queries_housing.yml'
        ]
    }
)